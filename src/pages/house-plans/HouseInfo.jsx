...
const HouseInfo = () => {
    ...
    const {
        slug, title, imageKeys, price, area, content
    } = house;
    ...
    return (
        ...
        >
            ...
            <div className="" style={{display: activeTab === "plan" ? "block" : "none"}}>
                <FloorPlan plan1Key={imageKeys.plan1Key} plan2Key={imageKeys.plan2Key} slug={slug}/>
            </div>
        </div>
    )
}
