    ...
    return (
        <div>
            ...
            <div className="tab__list shadowed">
                {
                    [
                        {title: "Фундамент: ", text: "монолитный, армированный"},
                        ...
                        {title: "Балки пола: ", text: "брус, 100х150мм (на ребро), шаг 0.90м"},
                        {title: "Межэтажные балки: ", text: "брес, 100х200мм (на ребро), шаг 0.90м"},
            ...
            <div className="tab__list shadowed">
                {
                    [
                        ...
                        {title: "Основные стены: ", text: "брус, 150х150мм, подняты на 1.40м (полутораэтажный"},
            ...
            <div className="tab__list shadowed">
                {
                    [
                        {title: "Крыша марсарда: ", text: "брус, 150х150мм"},
